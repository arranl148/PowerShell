...
# Original from NickolajA version 1.0.2
# From https://msendpointmgr.com/2019/10/31/silently-enable-bitlocker-for-hybrid-azure-ad-joined-devices-using-windows-autopilot/
#
.DESCRIPTION
    Enable BitLocker with both TPM and recovery password key protectors on Windows 10 devices.
